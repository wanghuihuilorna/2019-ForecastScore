...
if __name__ == '__main__':
    ...
    #
    #     predictions = xgb_model(X_train=exam_score, y=train_y,
    #                             df_test=submission_s1, columns=columns)
    #
    #     print(predictions)
    ...
    #     exam_score = exam_score.reindex(columns=columns).fillna(0)
    #
    #     predictions = lgb_model(X_train=exam_score, y=train_y,
    #                             df_test=submission_s1, columns=columns)
    #
    #     reuslt.extend(predictions.tolist())
    #
    ...
    data1.to_csv(load_data().get_project_path() + '/data/test_s1/submission_s1_sample_stack_baseline_1_xgb.csv', index=None,
                 encoding='utf-8')
